...
public class PointsView extends Container implements Observer {
	...
	public PointsView() {
		...
		numberAsteroid.getAllStyles().setFgColor(ColorUtil.rgb(0, 255, 0));
		...
		//numberAsteroid.getAllStyles().setBorder(Border.createCompoundBorder(
				...
				//null, 
				//null));	
		sound.getAllStyles().setFgColor(ColorUtil.rgb(0,255,0));
		...
		time.getAllStyles().setFgColor(ColorUtil.rgb(0,255,0));
		...
		lives.getAllStyles().setFgColor(ColorUtil.rgb(0, 255, 0));
		...
		/*lives.getAllStyles().setBorder(Border.createCompoundBorder(
				...
				null, 
				null));*/	
		missiles.getAllStyles().setFgColor(ColorUtil.rgb(0, 255, 0));
